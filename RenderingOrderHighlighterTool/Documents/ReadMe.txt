...
The default icons given with this plugin have a 2 or 3 letter acroynm like Bg (background), Ch (Character) or Fg (Foreground). However if you don't feel 
like creating your own icons, you can use the blank template and write an acronym of your choice (Max 5 characters). You can do this by opening the 'Rendering highlighters customizer'
window as above, then add a name in the 'Custom layer name' field option.  Leave empty if you want to use the default icons.
Since version 1.63 - the default icon is changed to the 'Blank' icon and the text is the first 4 characters of the layer name.
...
___________________________________________________________________
NGUI Layering support
Support for NGUI Panels and Widgets has been added in version 1.70 with the download of another plugin called 'NGUI Depth Highlighter'
It is available for Free for anyone who purchased this plugin already.
